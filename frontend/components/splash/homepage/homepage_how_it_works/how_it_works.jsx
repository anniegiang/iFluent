    ...
    <div className="homepage-how-works-animations">
      <div className="homepage-how-step-1">
        ...
        <div className="homepage-how-steps">
          <h1>
            <span>Choose Your Teacher</span>
          </h1>
          <p>
            <span>
              Watch teacher introduction videos and read reviews from other
              students.
            </span>
          </p>
      ...
      <div className="homepage-how-step-2">
        <div className="homepage-how-steps">
          ...
          <p>
            <span>Only schedule lessons at a time and date that suit you.</span>
          </p>
      ...
      <div className="homepage-how-step-1">
        ...
        <div className="homepage-how-steps">
          ...
          <p>
            <span>
              Connect with your teacher via video chat software, and let the
              learning begin!
            </span>
          </p>
